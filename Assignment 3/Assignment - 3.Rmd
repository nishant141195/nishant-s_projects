...
```{r}
customer = read.csv("C:/Users/welcome/Downloads/R - Retail Case study/R case study 1 (Retail)/Customer.csv")
transaction = read.csv("C:/Users/welcome/Downloads/R - Retail Case study/R case study 1 (Retail)/Transactions.csv")
product = read.csv("C:/Users/welcome/Downloads/R - Retail Case study/R case study 1 (Retail)/prod_cat_info.csv")
```
##Question - 1
```{r}
